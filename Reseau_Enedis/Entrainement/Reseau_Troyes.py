...
def create_Troyes_net(L_PV_gen):
    ...
    Conso_mw=np.array([19,52,13,23,22.5,22.5,1.5,94,22.5,22.5,1.4,1.2,1.3,22.8,1.5,1.5,1.5,1.3,1.5,1.5,1.4,1.5,1.5,1.5,1.2,1.1],dtype='float')
    ...
    #pp.set_user_pf_options(name=net_noes_pres_troyes, init_vm_pu = "flat", init_va_degree = "dc", calculate_voltage_angles=True)
...
net=create_Troyes_net(np.array([1,5,6,8],dtype='float'))
