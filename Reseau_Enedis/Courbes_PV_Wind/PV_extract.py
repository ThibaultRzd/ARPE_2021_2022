...
import numpy as np
def extraction_PV(chemin):
    df=pd.read_csv(chemin,sep=';',encoding="latin-1")
    Date=df['Horodate']
    Puiss=df[(df['Filière de production']=='F5 : Solaire')]
...
#On rempli maintenant les puissances par horodate si nécessaire
    ...
    plt.show()
extraction_PV("C:/Users/Thiba/OneDrive/Documents/2021_2022/TAF/ARPE/Data_PV_Wind/prod_PV_OCC_5_mai.csv")
